...
\newcommand{\applicants}{Dr.\ Martin H\"olzer, Robert Koch Institut, Berlin}
\newcommand{\project}{Projekttitel}
...
\paragraph{Erstes Arbeitspaket.}\mbox{}\\
\hrulefill
\label{wp:1}
...
\vspace*{0.5cm}\hrulefill
\paragraph{Zweites Arbeitspaket.}\mbox{}\\
\hrulefill
\label{wp:2}
