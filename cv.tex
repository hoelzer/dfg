...
\usepackage{proposal}
\usepackage{calc} % Add the calc package for arithmetic in dimensions

% Final compile switch
...
\todof{in table form only}
    
\begin{longtable}{|p{0.3\textwidth-2\tabcolsep}|p{\dimexpr 0.7\textwidth-2\tabcolsep\relax}|}
    \hline
    Title & \\
    \hline
    First name &  \\
...
\todof{mixture of table/free text}
\todoi{%
...
\todof{Part A required, Part B optional; free text}
\todoi{%
